/**
 * This modal is not being used anywhere yet
 */
...
public class SliderData {
	...
	public void init() {
		...
		String currentUri = parts.split("/jcr:content/homeContent/home-slider")[0];
		message = parts;
		Page rootPage = pageManager.getPage(currentUri);

		// check if page has slides child
		if (rootPage.getContentResource("home-slider") != null) {
			Resource resource = rootPage.getContentResource("home-slider");
